...
public class ThreadJoin3 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Save data begin timestamp is: "+ startTimestamp+",end timestamp is:"+endTimestamp);
    }
...
class CaptureRunnable implements Runnable{
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println(machineName + "complated data capture and successfully");
